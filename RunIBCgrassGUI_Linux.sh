...
g++ -c -fmessage-length=0 -std=c++11 -o SPftValInit.o SPftValInit.cpp 
...
g++ -o IBCgrassGUI SPftValInit.o SPftTraits.o RunPara.o Plant.o OutStructs.o LCG.o GMHerbicideEffect.o Cell.o CTKmodel.o CTDSeed.o CTDPlant.o CSeed.o CObject.o CHerbEff.o CGridEnvir.o CGrid.o CGenet.o CEnvir.o 
cd ..
